...
fnFs <- sort(list.files(file_path_as_absolute(path), pattern="_R1_001.fastq", full.names = TRUE))
fnRs <- sort(list.files(file_path_as_absolute(path), pattern="_R2_001.fastq", full.names = TRUE))
